...
export async function POST(req: Request) {
  ...
  <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #333;">
    ...
    <p>Пропоную <strong>персональну консультацію</strong> на якій ми конкретніше деталізуємо твій запит та вже сплануємо детальний фінансовий план, орієнтований на твої цілі й бажані терміни. Перша консультація безкоштовна.</p>
